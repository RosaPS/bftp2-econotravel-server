    ...
    public void loadSampleData() {
        if (experienceRepository.findAll().isEmpty()) {
            experienceRepository.saveAll(List.of(
                    ...
                    new Experience(1L,"Paseo en bicicleta por el Montseny", "Disfruta de un hermoso paseo en bicicleta por el increíble Parque Natural del Montseny.",
                            ...
                            250, 5, "Montaña, bicicleta, excursión larga", "https://www.kolotrip.com/wp-content/uploads/2019/12/mejores-viajes-en-bicicleta.jpg"),


                    new Experience(2L, "Descubre la costa en barco de vela", "Disfruta de un hermoso paseo acuático en barco de vela por la increíble costa de Barcelona.",
                    ...
                    new Experience(3L,"Descubre la Barcelona Modernista de noche", "La mejor forma de descubrir las maravillas modernistas que se esconden en el barcelonés distrito del Eixample",
                    ...
                    new Experience(4L,"Del huerto a la mesa", "Comparte con los más pequeños las maravillas de la naturaleza.",
                    ...
                    new Experience(5L,"Arte en la montaña sagrada ", "Disfruta de la impresionante Montaña de Montserrat ",
