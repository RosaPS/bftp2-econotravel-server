...
public class SampleDataLoader {
    ...
    public void loadSampleData() {
        experienceRepository.saveAll(List.of(
                ...
                new Experience("Descubre la costa en barco de vela", "Disfruta de un hermoso paseo acuático en barco de vela por la increíble costa de Barcelona.",
                ...
                new Experience("Del huerto a la mesa", "Comparte con los más pequeños las maravillas de la naturaleza.",
                ...
                new Experience("Arte en la montaña sagrada ", "Disfruta de la impresionante Montaña de Montserrat ",
